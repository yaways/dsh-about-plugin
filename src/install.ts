 ...
 */
export function discoverInstallation(entryPath: string | undefined = process.argv[1]): VersionFacts {
  const fallback: VersionFacts = { version: '0.0.0', anchor: process.cwd(), form: 'unknown' }
  if (entryPath === undefined || entryPath === '') return fallback
